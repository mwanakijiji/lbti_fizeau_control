...
def plot_analysis(csv_file):
    ...
    ax0.plot(opd_ret-1000, color="red", linestyle='None', markersize=10, alpha=1, label="Retrieved") # fake; just for legend
    ax0.axhline(y=10.7, linestyle = "--")
    ax0.axhline(y=-10.7, linestyle = "--")
    ...
    ax1.plot(opd_ret, color="red", linestyle='None', markersize=10, alpha=1)
    ...
    ax2.plot(tip_ret, color="red", linestyle='None', markersize=10, alpha=1)
    ...
    ax3.plot(tilt_ret, color="red", linestyle='None', markersize=10, alpha=1)
    ...
    ax4.plot(tilt_ret, color="red", linestyle='None', markersize=10, alpha=1)
    ...
    ax4.set_xlabel("Elapsed time (sec)", fontsize = 15.0)
    ...
    ax5.plot(tilt_ret, color="red", linestyle='None', markersize=10, alpha=1)
