...
print("----------------------------------------------------------------------------------")
raw_input("Place an ROI, no larger than 512x512, over the Phasecam sweet spot for LMIRcam. Size needs to be "+\
	"large enough to include the grism PSF and possible movement, e.g., ~400x200\n(HOSTS sweet spot was [880,800] on full detector in May 2018.)")
...
optimize_tt_fizeau_airy(mode = mode_choice) 
